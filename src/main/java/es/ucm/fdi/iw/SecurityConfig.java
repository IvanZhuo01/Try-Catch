	...
	protected void configure(HttpSecurity http) throws Exception {
	    http
			.csrf()
				...
				.and()
	        .authorizeRequests()
				.antMatchers("/api/**", "/user/**/pic", "/preguntas/**","/user/universidad/**/pic").permitAll()            // <-- public api access and user img
				.antMatchers("/admin/**").hasRole("ADMIN")	   // <-- administration
	            .antMatchers("/user/**", "/preguntas/responder/*", "/preguntas/votacion/*", "/preguntas/*", "/tutorial").hasRole("USER")	   // <-- logged-in users
